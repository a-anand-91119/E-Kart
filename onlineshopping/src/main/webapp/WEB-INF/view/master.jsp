...
<body>
	...
	<div class="main-wrapper">
		...
		<div class="wrapper-content">
			...
			<core:if
				test="${userClickedOption eq 'category' or userClickedOption eq 'allProducts'}">
			...
			<core:if
				test="${userClickedOption eq 'editProduct' or userClickedOption eq 'addProduct'}">
				<jsp:include page="include/addProduct.jsp"></jsp:include>
			</core:if>
		...
		<script type="text/javascript" src="${bootstrapMinJs}"></script>
		<script type="text/javascript"
			src="${dataTablesBootstrapResponsiveJs}"></script>
